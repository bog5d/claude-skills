...
- **商務接待耗能型直接淘汰**：如果简历或对话中体现出"应酬=消耗"，这类候选人坚决不要。这是波总明确划的红线
- **双模切换是核心**：最佳候选人应同时能"对外」和「能静下来做材料"——简历里既有对外经历又有深度研究/论文/证书
- 金融/通信/计算机/工科专业均可接受，不限金融科班
- **JD 未完全定稿先别打分**：等所有决策者补充完要求再建关键词库。波总的 JD 是口述多轮迭代出来的
...
- BOSS 直聘的网页端对 headless browser 零容忍（白屏/5KB空白图），不要浪费时间尝试。走手动下载路线。详见 `references/boss-integration-reality.md`。
